...
export default function DashboardLayout({
  ...
  return (
    <AuthGuard>
      <div className="flex min-h-screen flex-col bg-gradient-to-br from-blue-50/30 via-background to-blue-100/20 dark:from-blue-950/20 dark:via-background dark:to-blue-900/10">
        <Header />
        <div className="flex flex-1">
          <Sidebar />
          <main className="flex-1 p-4 md:p-6 pb-20 md:pb-6 relative">
